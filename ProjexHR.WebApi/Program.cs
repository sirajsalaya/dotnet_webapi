    ...
    private static void Main(string[] args)
    {
        ...
        builder.WebHost
               ...
               .ConfigureLogging(cfg =>
               {
                   // Serilog Logger
                   // cfg.ClearProviders();
                   cfg.AddSerilog(ProjexHR.Core.Logger.InitialiseLogger(), true);
               });
        ...
        // builder.Services.AddDbContext<ProjexHRContext>(
        ...
        app.UseWhen(predicate
            => predicate.Request.Path.StartsWithSegments("/api"),
               configuration
                => configuration.UseMiddleware<ProjexHR.Core.SerilogMiddleware>());
